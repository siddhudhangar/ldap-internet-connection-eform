...
public class ldaplogin extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		// TODO Auto-generated method stub
		  ...
		  String SelectedOfApproval=request.getParameter("SelectedOfApproval");
		 ...
		 // env.put(Context.PROVIDER_URL, "ldap://localhost:389");
		  ...
		  try { 	
		   ...
		   // Close the context when we're done
				...
				Cookie loginCookie1 = new Cookie("user",username);
				Cookie loginCookie2 = new Cookie("user1",SelectedOfApproval);
				Cookie loginCookie3 = new Cookie("user2",SelectAdmin);
				Cookie loginCookie4 = new Cookie("cn",cn);
				Cookie loginCookie5 = new Cookie("mail",mail);
	           	...
	           	loginCookie4.setMaxAge(240*60);
	           	loginCookie5.setMaxAge(240*60);
	           	...
	           	response.addCookie(loginCookie5);
	           		...
	           		else
	           		{
	           			...
	           			System.out.println(SelectAdmin);
		    		    response.sendRedirect("display.jsp"+"?"+username);
		    		}
