...
<meta http-equiv="refresh" content="9; URL=http://10.1.1.111:8080/hbcse_internet/home.jsp">
...
Connection connection=DriverManager.getConnection("jdbc:mysql://localhost:3306/hbcse_internet_user_info", "root", "root");
	...
	Statement statement1=connection.createStatement();
		String sql ="SELECT EmailOfMember,count(22) AS COUNT FROM registeruser WHERE status='Approved' AND ApprovedByHost<>'PENDING' AND ApprovedByApprovingMember<>'PENDING' AND mailsend1='SEND' AND mailsend2='SEND' AND mailsend3='PENDING' AND mailsend11='SEND' AND temp='SUCCESS' group by EmailOfMember";
		...
		Statement statement2=connection.createStatement();
       	String sql1 ="SELECT * FROM registeruser WHERE status='Approved' AND ApprovedByHost<>'PENDING' AND ApprovedByApprovingMember<>'PENDING' AND mailsend1='SEND' AND mailsend2='SEND' AND mailsend3='PENDING' AND mailsend11='SEND' AND temp='SUCCESS' AND EmailOfMember='"+email_id+"'";
		//resultSet = statement.executeQuery(sql);
		...
		String MailContent1="<table id=myTable align=center cellpadding=5 cellspacing=5 border=1>"
   		...
   		String sql3="UPDATE registeruser SET temp=? WHERE id=?";

		PreparedStatement stmt = connection.prepareStatement(sql3);
		stmt.setString(1, "ApprovedByHost");
		stmt.setInt(2, idnew);	
